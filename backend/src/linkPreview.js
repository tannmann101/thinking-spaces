...
// description/image out of the HTML that comes back. No database access,
// no Express -- kept separate the same way textLinks.jsx/listItems.js
// separate rendering/parsing from data, so it can be unit-tested directly
// and reused unchanged by worker/src/linkPreview.js.
